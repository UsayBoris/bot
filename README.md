...
- findOneAndUpdate works way better in some cases, changing some stuff;
- Permissions commands should be fixed;
- Removed all Music commands from the bot (not working after all);